...
class PayloadChannelAgent : public EnhancedEventEmitter,public CommonObserver<ChannelObserver>, public UVPipeObserver {
public:
    PayloadChannelAgent(ChannelObserver* obs);
    virtual ~PayloadChannelAgent();
